    ...
    <div className="flex w-full flex-1" style={{ minHeight: 'calc(100vh - 68px)' }}>
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-coffee-oyster text-xs font-semibold uppercase tracking-[0.2em] mb-4">Account recovery</p>
          ...
          <p className="text-coffee-roman text-sm leading-relaxed max-w-xs" style={{ fontFamily: 'var(--font-handwritten)', fontSize: '1rem' }}>
            Enter your email and we'll send a reset link — back to your morning routine in no time.
          </p>
        </div>
        <div className="relative z-10">
        ...
        <div className="w-full max-w-md">
          ...
          {submitted ? (
            <div className="text-center">
              ...
              >
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#6B5C52" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.62 3.45 2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.95a16 16 0 0 0 6 6l.95-.95a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 16.92z"/>
                </svg>
              </div>
              <h1 className="font-handwritten text-coffee-oil mb-3" style={{ fontSize: '2rem' }}>Check your inbox</h1>
              <p className="text-coffee-roman text-sm leading-relaxed mb-8" style={{ fontFamily: 'var(--font-handwritten)', fontSize: '0.95rem' }}>
                If that email is registered, we've sent a password reset link. It expires in 1 hour.
              </p>
              <Link
                href="/login"
                className="text-coffee-cappuccino font-semibold hover:text-coffee-judge text-sm"
            ...
            <>
              <div className="mb-8">
                <h1 className="font-handwritten text-coffee-oil mb-1" style={{ fontSize: '2.25rem' }}>Forgot password?</h1>
